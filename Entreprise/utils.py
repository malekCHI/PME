...
def add_entreprise(nom, adresse, description,email,tel):
    entreprise = Entreprise(nom=nom,adresse=adresse,description=description,email=email,tel=tel) 
    entreprise.save_to_db()
    
    
def update_entreprise(_id_Entreprise, _nom,_adresse,_description,_creation_date,_email,_tel):
