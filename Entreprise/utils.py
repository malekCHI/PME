...
def add_entreprise(nom, adresse, description,email,tel,id_user):
    entreprise = Entreprise(nom=nom,adresse=adresse,description=description,email=email,tel=tel,id_user=id_user) 
    entreprise.save_to_db()
    
    
def update_entreprise(_id_Entreprise, _nom,_adresse,_description,_creation_date,_email,_tel,_id_user):
    ...
    if entreprise_to_update:
        ...
        entreprise_to_update.id_user=_id_user
